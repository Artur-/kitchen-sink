...
public class SelectDemoView extends VerticalLayout {
    ...
    public SelectDemoView() {
        ...
        Playground<Select<String>> playground = new Playground<>(playgroundSelect)
        ...
        playground.addExample("Basic Select", basic);
        ...
        playground.addExample("Disabled Items", partiallyDisabled);
        ...
        playground.addExample("Empty Selection Allowed", emptyAllowed);
